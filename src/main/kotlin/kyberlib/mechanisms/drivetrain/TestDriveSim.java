...
public class TestDriveSim {
    ...
    public void update(double dtSeconds) {
        ...
        m_x = NumericalIntegration.rkf45(this::getDynamics, m_x, m_u, dtSeconds);
        m_y = m_x;
     ...
     *     point.
     */
    public static TestDriveSim createKitbotSim(
            KitbotMotor motor,
